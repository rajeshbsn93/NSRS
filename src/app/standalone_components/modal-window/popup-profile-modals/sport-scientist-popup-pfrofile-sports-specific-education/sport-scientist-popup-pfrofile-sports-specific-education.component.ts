...
@Component({
  selector: 'app-sport-scientist-popup-pfrofile-sports-specific-education',
  templateUrl: './sport-scientist-popup-pfrofile-sports-specific-education.component.html',
  styleUrls: ['./sport-scientist-popup-pfrofile-sports-specific-education.component.css'],
  standalone: true,
  imports: [CommonModule, LoaderComponent],
})
export class SportScientistPopupProfileSportsSpecificEducatioComponent implements OnInit {
