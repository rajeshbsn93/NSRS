...
@Component({
    selector:'app-sport-scientist-popup-pfrofile-award',
    templateUrl:'./sport-scientist-popup-pfrofile-award.component.html',
    styleUrls:['./sport-scientist-popup-pfrofile-award.component.css'],
    standalone:true,
...
export class SportScientistPopupProfileAwardComponent implements OnInit{
