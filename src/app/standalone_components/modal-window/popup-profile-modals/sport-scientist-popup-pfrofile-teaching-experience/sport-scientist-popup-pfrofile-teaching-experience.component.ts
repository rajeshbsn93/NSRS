...
@Component({
    selector:'app-sport-scientist-popup-pfrofile-teaching-experience',
    templateUrl:'./sport-scientist-popup-pfrofile-teaching-experience.component.html',
    styleUrls:['./sport-scientist-popup-pfrofile-teaching-experience.component.css'],
    standalone:true,
    imports:[CommonModule,MaterialModule,LoaderComponent]
})

export class SportScientistPopupProfileTeachingExperienceComponent implements OnInit{
    loader:boolean = false;
    @ViewChild(MatPaginator) paginator!: MatPaginator;
    @ViewChild(MatSort) sort!: MatSort;
    experienceTableData = new MatTableDataSource<teaching_ExperienceEntity>();
    experienceTableColumns:string[] = ['sl','year_of_experience','institute_of_teaching','remark',];
    ...
    getTeachingExperience(){
        this.loader = true;
        this.experienceService.teaching_Experience(this.official_detail_id).subscribe({
            next:(response:any)=>{
                this.loader = false;
