...
@Component({
  selector: 'app-kisce-add-attendance',
  templateUrl: './kisce-add-attendance.component.html',
  styleUrls: ['./kisce-add-attendance.component.css'],
    providers: [
...
export class KisceAddAttendanceComponent implements OnInit {
