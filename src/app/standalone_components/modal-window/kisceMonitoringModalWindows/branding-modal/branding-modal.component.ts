...
@Component({
  ...
  styleUrls: ['./branding-modal.component.css'],
  providers: [
 ...
 multiEquipmentTagForm!:FormGroup;
  ...
  AddMultiTagArray(modal:any):FormGroup{
    return this.fb.group({
      branding_kic:[modal.action=='edit'? this.userDetails.role_id==this.KicUsersRoleId.kisceAdmin ? modal.data.branding_done: modal.data.branding_done :'',Validators.required],
      upload_image:[modal.action=='edit'? this.userDetails.role_id==this.KicUsersRoleId.kisceAdmin ? modal.data.upload_image : modal.data.upload_image :'' ],
      ...
      kiuid: [this.userDetails.role_id==this.KicUsersRoleId.kisceAdmin ? this.brandingModalData.kiuid ?  this.brandingModalData.kiuid : '' : this.brandingModalData.data.kiC_KUID],
      bid: [modal.action=='edit' ? this.userDetails.role_id==this.KicUsersRoleId.kisceAdmin ? modal.data.bid : modal.data.bid :0,Validators.required]
    })
  }
