...
@Component({
  selector: 'app-kisce-cctv-feed',
  templateUrl: './kisce-cctv-feed.component.html',
  styleUrls: ['./kisce-cctv-feed.component.css'],
  standalone:true,
...
export class KisceCctvFeedComponent implements OnInit {
  ...
  AddMultiTagArray(modal:any):FormGroup{    
    return this.fb.group({
      ...
      academy_kuid:[modal.action == 'edit' ? ( this.userDetails.role_id==this.KicUsersRoleId.kisceAdmin ? this.userDetails.nsrs_id : modal.data.kitd_unique_id) : this.userDetails.nsrs_id,Validators.required],
