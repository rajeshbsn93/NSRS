...
@Component({
  selector: 'app-kisce-sanction-total-amount',
  templateUrl: './kisce-sanction-total-amount.component.html',
  styleUrls: ['./kisce-sanction-total-amount.component.css'],
  providers: [
...
export class KisceSanctionTotalAmountComponent implements OnInit {
  ...
  createRow(data?: any) {
    return this.fb.group({
      ...
      amount: [data?.amount || '', [Validators.required, Validators.pattern('^[1-9][0-9]*$')]],
