...
@Component({
  selector: 'app-comment-history-kisce',
  templateUrl: './comment-history-kisce.component.html',
  styleUrls: ['./comment-history-kisce.component.css'],
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule, MaterialModule, LoaderComponent],
})
export class CommentHistoryKisceComponent implements OnInit {
