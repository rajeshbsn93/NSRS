...
@Component({
  selector: 'app-india-map-density',
  templateUrl: './india-map-density.component.html',
  styleUrls: ['./india-map-density.component.css']
})
export class IndiaMapDensityComponent implements OnInit {
