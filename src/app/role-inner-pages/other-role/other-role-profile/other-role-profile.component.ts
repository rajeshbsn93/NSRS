...
@Component({
    selector:'app-other-role-profile',
    templateUrl:'./other-role-profile.component.html',
    styleUrls:['./other-role-profile.component.css']
})

export class OtherRoleProfileComponent implements OnInit, OnDestroy{
