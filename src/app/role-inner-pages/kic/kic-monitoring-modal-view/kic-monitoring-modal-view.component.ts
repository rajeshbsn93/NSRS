...
@Component({
  selector: 'app-kic-monitoring-modal-view',
  templateUrl: './kic-monitoring-modal-view.component.html',
  styleUrls: ['./kic-monitoring-modal-view.component.css'],
  standalone:true,
  imports:[CommonModule,ReactiveFormsModule,MaterialModule,LoaderComponent]
})
export class KicMonitoringModalViewComponent implements OnInit {
  ...
  getTabData(elementData:any){
    ...
    var equipmentData$= this._equipmentProcurementService.getEquipmentProcurement(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id);
    var pcaData$= this._equipmentProcurementService.getPCAListForKic(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id);
    var brandingData$=this._equipmentProcurementService.getBranding(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id);
    var trainingData$=this._equipmentProcurementService.getTrainingDetailsList(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id);
    var cctvData$=this._equipmentProcurementService.getCctvFeedList(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id);
  ...
  // getEquipmentDetails(){
  //   this._equipmentProcurementService.getEquipmentProcurement(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id).subscribe({
  //     next:(res:any)=>{
  //       if(res.status){
  //         // this.dataSourceForEquipment=res.data
  //         this.dataSourceForEquipment = new MatTableDataSource(res.data);
  //         this.dataSourceForEquipment.paginator = this.kicEuipmentWISEPaginator
  //         // setTimeout(() => this.dataSourceForEquipment.paginator = this.kicEuipmentWISEPaginator);
  //       }else{
  //         this.dataSourceForEquipment = new MatTableDataSource([]);
  //         this.dataSourceForEquipment.paginator = this.kicEuipmentWISEPaginator
  //         // setTimeout(() => this.dataSourceForEquipment.paginator = this.kicEuipmentWISEPaginator);
  ...
  // getPCADetails(){
  //   this._equipmentProcurementService.getPCAListForKic(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id).subscribe({
  //     next:(pcaRes:any)=>{
  //       if(pcaRes.status){
  //         this.dataSourceForPCA=new MatTableDataSource(pcaRes.data)
  //         this.dataSourceForPCA.paginator = this.kicPCAPaginator
  //         // setTimeout(() => this.dataSourceForPCA.paginator = this.kicPCAPaginator);
  //       }else{
  //         this.dataSourceForPCA=new MatTableDataSource([])
  //         this.dataSourceForPCA.paginator = this.kicPCAPaginator
  //         // setTimeout(() => this.dataSourceForPCA.paginator = this.kicPCAPaginator);
  //       }
  //     },
  ...
  // getBrandingDetails(){
  //   this._equipmentProcurementService.getBranding(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id).subscribe({
  //     next:(brandingRes:any)=>{
  //       if(brandingRes.status){
  //         this.dataSourceForBranding=new MatTableDataSource(brandingRes.data)
  //         this.dataSourceForBranding.paginator = this.kicBrandingWISEPaginator
  //       }else{
  //         this.dataSourceForBranding=new MatTableDataSource([])
  //       }
  //     },
  //     error:()=>{
  //       this.dataSourceForBranding=[]
  //     }
  //   })
  // }

  // getTrainingDetails(){
  //   this._equipmentProcurementService.getTrainingDetailsList(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id).subscribe({
  //     next:(trainingRes:any)=>{
  //       if(trainingRes.status){
  //         this.dataSourceForTraining=new MatTableDataSource(trainingRes)
  //         this.dataSourceForTraining.paginator=this.kicTrainingWISEPaginator
  //       }else{
  //         this.dataSourceForTraining=[]
  //       }
  //     },
  ...
  // getCCTVDetails(){
  //   this._equipmentProcurementService.getCctvFeedList(this.equipmentModalViewData.user_id,this.equipmentModalViewData.role_id).subscribe({
  //     next:(cctvRes:any)=>{
  //       if(cctvRes.status){
  //         this.dataSourceForCCTV=new MatTableDataSource(cctvRes.data);
  //         this.dataSourceForCCTV.paginator=this.kicCCTVWISEPaginator
  //       }else{
  //         this.dataSourceForCCTV=[]
  //       }
  //     },
