...
@Component({
  selector: 'app-kic-table-view',
  templateUrl: './kic-table-view.component.html',
  styleUrls: ['./kic-table-view.component.css']
})
export class KicTableViewComponent implements OnInit {
