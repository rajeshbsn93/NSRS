...
@Component({
    selector:'app-athlete-details-achievement',
    templateUrl:'./athlete-details-achievement.component.html',
    styleUrls:['./athlete-details-achievement.component.css'],
    providers: [
...
export class AthleteDetailsAchievementComponent implements OnInit{
