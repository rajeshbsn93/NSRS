...
import { AddEditCoachAwardReceivedComponent } from "../add-edit-coach-award-received/add-edit-coach-award-received.component";

@Component({
    selector:'app-coach-award-received',
    templateUrl:'./coach-award-received.component.html',
    styleUrls:['./coach-award-received.component.css'],
    standalone:true,
...
export class CoachAwardReceivedComponent implements OnInit{
    ...
    addEdit(data:any){
        const modalRef = this.modalService.open(AddEditCoachAwardReceivedComponent,{centered:true,size:'xl',backdrop:'static',keyboard:false});
