...
@Component({
    selector: 'app-add-edit-recruitment-sports-quota',
    templateUrl: './add-edit-recruitment-sports-quota.component.html',
    styleUrls: ['./add-edit-recruitment-sports-quota.component.css'],
    standalone: true,
...
export class AddEditRecruitmentSportsQuotaComponent implements OnInit {
