...
@Component({
    ...
    templateUrl:'./experience-national-camp.component.html',
    styleUrls:['./experience-national-camp.component.css'],
    standalone:true,
...
export class ExperienceNationalCampComponent implements OnInit{
