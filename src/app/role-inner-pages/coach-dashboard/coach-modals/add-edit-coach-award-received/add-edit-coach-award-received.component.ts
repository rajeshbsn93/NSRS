...
@Component({
    selector:'app-add-edit-coach-award-received',
    templateUrl:'./add-edit-coach-award-received.component.html',
    styleUrls:['./add-edit-coach-award-received.component.css'],
    standalone:true,
...
export class AddEditCoachAwardReceivedComponent implements OnInit{
    ...
    ngOnInit(): void {
        ...
        if(this.editData !=null){
            ...
            this.yearVal = this.editData.award_year
        } 
    }
